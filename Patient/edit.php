...
if(isset($_POST['Update'])){
    ...
    $sql="Update patients Set firstName='$fname', lastName='$lname', phoneNumber='$pno',dateofBirth='$dob',addresses='$addresses',gender='$gender',username='$uname',passwords='$pword',eMail='$email' Where SSN='$ssn'";
